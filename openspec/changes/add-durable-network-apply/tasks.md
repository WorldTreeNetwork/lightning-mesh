...
- [x] Implementation-readiness advise of those pins (other-family reader; r2 accept)
...
- [x] OpenWrt adapter + shared flock + boot/service recovery-first (software-only; not live radio)
